...
export const myProjects = [
  {
    ...
    desc: "Infinite Ideas Hub is a dynamic blog website crafted with the power of Next.js. Dynamic blog application built with full-stack technologies for content publishing and user interaction.",
    subdesc:
      "This platform enables users to read and interact with blogs through features like liking, commenting, and exploring related posts. It includes a detailed blog view, author pages, and responsive UI with clean design. Built with Next.js, MongoDB, and Tailwind CSS, the app emphasizes performance, SEO, and modular code architecture.",
